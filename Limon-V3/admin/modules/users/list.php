	...
	<div class="simplebox grid740">
        ...
        <table class="tablesorter list"> 
            <thead> 
                <tr> 
                    <th width="2%"></th> 
                    <th width="60%">Adı Soyadı / Email</th> 
                    <th align="center">Kayıt Tarihi</th> 
                    <th width="10%">İşlemler</th> 
                </tr> 
            </thead> 
            <tbody> 
			<?php
			$query = mysql_query("SELECT * FROM ".module_table." ORDER BY id DESC");
			...
			?>
                <tr id="data<?=$list["id"]?>"> 
					...
					<td align="center"><?=$mth->trDate($list["register_date"]);?></td>
                    <td>
						<a class="tips" title="Üyeyü Düzenle" href="<?=module_link?>/edit&id=<?=$list["id"]?>">
							<img src="img/icons/sidemenu/file_edit.png" alt="" />
						</a>
						<a class="tips" title="Üyeyi Sil" href="<?=module_link?>/list&deleteID=<?=$list["id"]?>">
